{{-- membros-inativos.blade.php --}}
<div class="p-6 space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-4 lg:mb-6">Membros Inativos</h1>
    ...
    <div class="max-w-7xl mx-auto px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 lg:gap-6 mb-6 lg:mb-8">
            ...
            <div
                class="bg-indigo-100 p-4 lg:p-5 rounded-xl border border-indigo-200 transform hover:scale-105 transition-transform duration-200">
                <div class="flex justify-between items-start mb-2">
                    <span class="text-gray-700 font-medium text-sm lg:text-base">Procuradores de Justiça</span>
            ...
            <div
                class="bg-teal-100 p-4 lg:p-5 rounded-xl border border-teal-200 transform hover:scale-105 transition-transform duration-200">
                <div class="flex justify-between items-start mb-2">
                    <span class="text-gray-700 font-medium text-sm lg:text-base">Promotores Entrância Inicial</span>
            ...
            <div
                class="bg-yellow-100 p-4 lg:p-5 rounded-xl border border-yellow-200 transform hover:scale-105 transition-transform duration-200">
                <div class="flex justify-between items-start mb-2">
            ...
            <div
                class="bg-pink-100 p-4 lg:p-5 rounded-xl border border-pink-200 transform hover:scale-105 transition-transform duration-200">
                <div class="flex justify-between items-start mb-2">
            ...
            <div
                class="bg-green-100 p-4 lg:p-5 rounded-xl border border-green-200 transform hover:scale-105 transition-transform duration-200">
                <div class="flex justify-between items-start mb-2">
        ...
        <div class="flex flex-col lg:flex-row gap-6 mb-8">
            <div class="flex-1 flex flex-col">
                <x-charts.simple id="inativos_situacao" type="doughnut" title="Cargo Efetivo (%)" :data="[
                    'labels' => [
            ...
            <div class="flex-1 flex flex-col">
                <x-charts.simple id="inativos_cargo_efetivo_qtd" type="bar" title="Cargo Efetivo (Qtd)"
                    :data="[
                        'labels' => [
        ...
        <!-- Seção 2: Lotação Top 5 (%) e Lotação Top 15 (Qtd) lado a lado -->
        <div class="flex flex-col lg:flex-row gap-6 mb-8">
            <div class="flex-1 flex flex-col">
                <x-charts.simple id="lotacao_top_5" type="doughnut" title="Lotação Top 5 (%)" :data="[
                    'labels' => [
                        'Outros',
                        'Ministério Público do Amapá - Substitutos',
                        'Procuradoria Geral de Justiça',
                        'Promot Inf e Juventude de Macapá',
                        'Promotoria de Laranjal do Jari',
                    ],
                    'datasets' => [
                        [
            ...
            <div class="flex-1 flex flex-col">
                <x-charts.simple id="lotacao_top_15" type="bar" title="Lotação Top 15 (Qtd)" :data="[
                    'labels' => [
                        'Ministério Público do Amapá - Substitutos',
                        'Promotoria de Laranjal do Jari',
                        'Procuradoria Geral de Justiça',
                        'Promot Inf e Juventude de Macapá',
                        '1ª Promotoria',
                        'Promotoria de Oiapoque',
                        'Gabinete de Procuradoria - Dra. Margeilla Campelo',
                        'Gabinete de Procuradoria - Dra. Estela Nascimento',
                        'Gabinete de Procuradoria - Dr. Márcio Alves',
                        'Gab. de Família, Órfãos Sucessões e Incap. Mcp',
                        'Gab. Proc. Justiça Dr. Manuel Felipe Menezes S. Júnior',
                        'Gab. de Procuradoria Dra. Ivana Lúcia Franco Cei',
                        'Gabinete de Procuradoria Dr. Joel Chaggas',
                        'Gab. Dra. Gilaudia Pachno Nunes',
                    ],
                    'datasets' => [
                        [
                    ...
                    :height="'h-80'" class="h-full min-h-[20rem]" :options="[
                        'indexAxis' => 'y',
                        'elements' => [
                            'bar' => [
                                'borderRadius' => 8,
    ...
    <div class="w-full mb-8">
        <x-charts.simple id="inativos_tempo_atuacao" type="bar" title="Tempo de Atuação no MP-AP" :data="[
            'labels' => [
                '33 anos',
                '17 anos',
                '2 anos',
