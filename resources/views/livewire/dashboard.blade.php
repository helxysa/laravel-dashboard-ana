<div class="space-y-6 lg:space-y-8" x-data="{ 
    ...
    <div>
        ...
        <div class="flex">
            <button 
                @click="activeTab = 'visao-geral'; $nextTick(() => { if (!chartsInitialized) initCharts(); })"
            ...
            <button 
                @click="activeTab = 'gestao-pessoas'"
        ...
        <div class="relative bg-white p-4 md:p-6 lg:p-8 rounded-b-lg rounded-tr-lg border border-gray-200 shadow-sm">
            ...
            <!-- visao geral -->
            <div x-show="activeTab === 'visao-geral'" 
                 x-transition:enter="transition ease-out duration-300" 
                 x-transition:enter-start="opacity-0" 
                 x-transition:enter-end="opacity-100"
                 x-init="if (activeTab === 'visao-geral') { $nextTick(() => { if (!chartsInitialized) initCharts(); }); }">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
                        <h3 class="text-base lg:text-lg font-semibold text-gray-900 mb-3 lg:mb-4">Distribuição por Promotorias</h3>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
                        <h3 class="text-base lg:text-lg font-semibold text-gray-900 mb-3 lg:mb-4">Status dos Servidores</h3>
                        <div class="h-40 lg:h-48 xl:h-52">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
                        <h3 class="text-base lg:text-lg font-semibold text-gray-900 mb-3 lg:mb-4">Servidores por Promotoria</h3>
                        <div class="h-40 lg:h-48 xl:h-52">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
                        <h3 class="text-base lg:text-lg font-semibold text-gray-900 mb-3 lg:mb-4">Distribuição de Status</h3>
                        <div class="h-40 lg:h-48 xl:h-52">
                ...
                <!-- grafico maior -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
                    <h2 class="text-lg lg:text-xl font-semibold text-gray-900 mb-3 lg:mb-4">Evolução do Patrimônio de TI</h2>
            ...
            <!-- gestao de pessoas -->
            <div x-show="activeTab === 'gestao-pessoas'" 
                 x-transition:enter="transition ease-out duration-300" 
                 x-transition:enter-start="opacity-0" 
                 x-transition:enter-end="opacity-100">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr>
                                    <td class="py-3 lg:py-4 px-2 lg:px-4 flex items-center gap-2 lg:gap-3">
                                        <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold text-xs lg:text-sm">AS</div>
                                        <div>
                                            <div class="font-medium text-xs lg:text-sm">Ana Silva</div>
                                            <div class="text-xs text-gray-500">@anasilva</div>
                                        </div>
                                    </td>
                                    <td class="py-3 lg:py-4 px-2 lg:px-4 text-xs lg:text-sm">Desenvolvedora Frontend</td>
                                    <td class="py-3 lg:py-4 px-2 lg:px-4 text-xs lg:text-sm">ana.silva@example.com</td>
                                    <td class="py-3 lg:py-4 px-2 lg:px-4"><span class="bg-green-100 text-green-800 text-xs font-semibold px-2 py-1 rounded-full">Ativo</span></td>
                                </tr>
                                <tr>
                                    <td class="py-3 lg:py-4 px-2 lg:px-4 flex items-center gap-2 lg:gap-3">
                                        <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 font-semibold text-xs lg:text-sm">CP</div>
                                        <div>
                                ...
                                <tr>
                                    <td class="py-3 lg:py-4 px-2 lg:px-4 flex items-center gap-2 lg:gap-3">
                                        <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 font-semibold text-xs lg:text-sm">MC</div>
                                        <div>
                                    ...
                                    <td class="py-3 lg:py-4 px-2 lg:px-4"><span class="bg-yellow-100 text-yellow-800 text-xs font-semibold px-2 py-1 rounded-full">Férias</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
function initCharts() {
    setTimeout(() => {
        ...
        createChart('chart4', {
            ...
            datasets: [{
                label: 'Status',
                data: [@json($metricas['ativos']), @json($metricas['inativos']), @json($metricas['em_manutencao'])],
                backgroundColor: [
                    'rgba(59, 130, 246, 0.9)',
                    'rgba(239, 68, 68, 0.9)',
